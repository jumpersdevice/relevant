...
_graphqlCompose.schemaComposer.Query.addFields(
  _objectSpread(
    _objectSpread(_objectSpread({}, _treasury.treasuryQuery), _user.userQuery),
    _member.memberQuery
  )
);

_graphqlCompose.schemaComposer.Subscription.addFields(
  _objectSpread(_objectSpread({}, _user.userSubscription), _member.memberSubscription)
);

_graphqlCompose.schemaComposer.Mutation.addFields(
  _objectSpread({}, _member.memberMutation)
);
