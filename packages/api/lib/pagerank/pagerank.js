...
function pagerank(nodes, params) {
  ...
  var now = new Date();
  var { g, N, dictionary, danglingNodes, degreeStore, personalization } = (0,
  _initMatrix.default)(nodes, params);
  ...
  var danglingWeights = dictionary.danglingConsumer
    ? []
...
function setupTrustSeed(_ref) {
  var { N, dictionary, g, personalization } = _ref;
...
function initialRank(_ref2) {
  var { nodes, params, dictionary, N } = _ref2;
...
function runLoop(loopParams, params) {
  var { x } = loopParams;
  var { p, g, N, danglingNodes, danglingWeights } = loopParams;
  var xlast = [...x];
