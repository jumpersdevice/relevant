...
function _computeApproxPageRank() {
  _computeApproxPageRank = (0, _asyncToGenerator2.default)(function*(_ref) {
    var { author, post, user, communityId, vote, undoInvest } = _ref;
    ...
    try {
      ...
      var { maxUserRank, maxPostRank } = com; // if user relevance object doesn't exist, there is nothing to update
      ...
      var negPosRatio = member.pagerankRaw
