...
function _handleResults() {
  _handleResults = (0, _asyncToGenerator2.default)(function*(_ref) {
    var { scores, nodes, communityId, debug, postNodes } = _ref;
    var max = 0;
    var secondMax = 0;
    var min = 0;
    var maxPost = 0;
    ...
    var sortedNodes = [...Object.values(postNodes), ...Object.values(nodes)]
...
function _updateItemRank() {
  _updateItemRank = (0, _asyncToGenerator2.default)(function*(props) {
    var { secondMax, maxPost, node, N, debug, communityId } = props;
    var { min, minPost } = props;
    min = 0;
    minPost = 0;
    var rank;
    var userRank =
