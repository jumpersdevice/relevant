...
function _setupPosts() {
  _setupPosts = (0, _asyncToGenerator2.default)(function* () {
    ...
    yield link1.addPostData(_objectSpread(_objectSpread({}, _post2.linkPost1), _post2.linkPost1.altCommunity));
    ...
    var addToFeed = [link1, link2, link3, link4, link5].map( /*#__PURE__*/function () {
...
function _setupUsers() {
  _setupUsers = (0, _asyncToGenerator2.default)(function* () {
    var users = _user3.allUsers.map( /*#__PURE__*/function () {
...
function _setupCommunities() {
  _setupCommunities = (0, _asyncToGenerator2.default)(function* () {
    var communities = _community3.allCommunities.map( /*#__PURE__*/function () {
