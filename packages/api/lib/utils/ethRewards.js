...
exports.rewards = /*#__PURE__*/ (0, _asyncToGenerator2.default)(function*() {
  ...
  try {
    ...
    if (rewardPool < 0)
      throw new Error('not enough funds in reward pool '.concat(rewardPool));
  } catch (err) {
    console.log(err);
  ...
  try {
      ...
      q.push(
        /*#__PURE__*/ (function() {
          var _ref2 = (0, _asyncToGenerator2.default)(function*(cb) {
            community = yield computeCommunityRewards(
              community,
              rewardPool,
              stakedTokens
            );
            var { updatedPosts, postPayouts } = yield postRewards(community);
            var { payouts, distributedRewards } = yield distributeUserRewards(
              updatedPosts,
              community
            );
            var res = {
    ...
    var totalDistributedRewards = Object.values(payoutData).reduce(
...
function _updateRewardAllocation() {
  _updateRewardAllocation = (0, _asyncToGenerator2.default)(function*() {
    ...
    var { unAllocatedRewards } = treasury || {};
...
function _computeCommunityRewards() {
  _computeCommunityRewards = (0, _asyncToGenerator2.default)(function*(
    community,
    rewardPool,
    stakedTokens
  ) {
...
function communityRewardShare(_ref3) {
  var { community, stakedTokens, rewardPool } = _ref3;
  var totalBalance = stakedTokens.reduce((a, c) => c.stakedTokens + a, 0);
...
function _postRewards() {
  _postRewards = (0, _asyncToGenerator2.default)(function*(community) {
    ...
    var decay = IS_TEST
      ? 0
      : (now.getTime() - community.lastRewardFundUpdate.getTime()) /
        _globalConstants.SHARE_DECAY;
    ...
    var updatedPosts = posts.map(
      /*#__PURE__*/ (function() {
        var _ref5 = (0, _asyncToGenerator2.default)(function*(post) {
          ...
          post.payoutShare = Math.min(
            0.05,
            post.pagerank / (community.topPostShares || 1)
          );
...
function _distributeUserRewards() {
  _distributeUserRewards = (0, _asyncToGenerator2.default)(function*(posts, _community) {
    var { slug: community, _id: communityId } = _community;
    var payouts = {};
    var distributedRewards = 0;
    var updatedUsers = posts.map(
      /*#__PURE__*/ (function() {
            ...
            /*#__PURE__*/ (function() {
              var _ref7 = (0, _asyncToGenerator2.default)(function*(vote) {
                ...
                payouts[user._id] = payouts[user._id]
                  ...
                  : curationPayout; // TODO diff decimal?
...
function _sendNotification() {
  _sendNotification = (0, _asyncToGenerator2.default)(function*(props) {
    var { user, reward, post, community, communityId, type, postData } = props;
    var s = reward === 1 ? '' : 's';
    ...
    var text = 'You earned '
      .concat(amount, ' coin')
      .concat(s, ' from ')
      .concat(action, 'this post');
    var alertText = 'You earned '
      .concat(amount, ' coin')
      .concat(s, ' from ')
      .concat(action, 'a post');
