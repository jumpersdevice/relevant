...
var { RELEVANT_ENV, SYS_ADMIN_EMAIL } = process.env;
...
function _auditUser() {
  _auditUser = (0, _asyncToGenerator2.default)(function*(handle) {
    ...
    var adjust = 0;
    var postData = yield earnings.map(
      /*#__PURE__*/ (function() {
        var _ref = (0, _asyncToGenerator2.default)(function*(e) {
          ...
          var estimatedReward = !postdata.payout
            ? 0
