...
process.on('beforeExit', /*#__PURE__*/(0, _asyncToGenerator2.default)(function* () {
...
function _getGasPrice() {
  _getGasPrice = (0, _asyncToGenerator2.default)(function* (gasSpeed) {
    ...
    var gasPrice = yield (0, _requestPromiseAny.default)('https://ethgasstation.info/json/ethgasAPI.json');
...
function _sign() {
  _sign = (0, _asyncToGenerator2.default)(function* (_account, _amount) {
    ...
    var hash = _ethers.ethers.utils.solidityKeccak256(['uint256', 'address', 'uint256'], [amount, _account, nonce]);
