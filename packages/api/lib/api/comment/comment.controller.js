...
exports.index = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)(function* (req) {
    ...
    var comments = yield _post.default.find(query).populate([...myVote, {
...
exports.create = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)(function* (req, res, next) {
    try {
      ...
      if (user.banned) {
        throw new Error('You are temporarily blocked from making comments, if you think this is an error, please reach out to info@relevant.community');
      }
      ...
      var commentAuthor = parentComment && (yield _user.default.findOne({
        _id: parentComment.user
      }, 'name _id deviceTokens handle email notificationSettings'));
      var otherCommentors = yield _post.default.find({
      ...
      var voters = yield _invest.default.find({
        post: parentPost._id
      }).populate('investor', 'name _id deviceTokens handle email notificationSettings');
      var commentVoters = parentComment && (yield _invest.default.find({
      ...
      otherCommentors.forEach(commentor => sendNotifications({
        commentor,
        postAuthor,
        commentAuthor,
        repost,
...
function _sendNotifications() {
  _sendNotifications = (0, _asyncToGenerator2.default)(function* (_ref3) {
    ...
    var action = " replied to ".concat(ownPost || ownComment ? 'your' : 'a', " ").concat(type);
