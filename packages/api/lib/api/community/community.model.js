...
CommunitySchema.path('slug').validate(slug => _text.NAME_PATTERN.test(slug), 'Username can only contain letters, numbers, dashes and underscores');
CommunitySchema.pre('remove', /*#__PURE__*/function () {
  var _remove = (0, _asyncToGenerator2.default)(function* (next) {
    ...
    var leave = members.map( /*#__PURE__*/function () {
