...
function _index() {
  _index = (0, _asyncToGenerator2.default)(function*(req) {
    ...
    var communties = yield _community.default
      .find(
        _objectSpread(
          _objectSpread(
            {
    ...
    if (user) {
      var memberships = yield _communityMember.default
        .find({
          user: user._id
        })
        .populate({
...
function _members() {
  _members = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      var users = yield _communityMember.default
        .find({
          community,
...
function _membership() {
  _membership = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      var m = yield _communityMember.default
        .find({
          user
        })
  ...
  _create = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      if (RESERVED.indexOf(slug) > -1)
        throw new Error('The slug '.concat(slug, ' cannot be used'));
      var newCommunity = {
        slug,
        image: c.image,
        name: c.name,
      ...
      var { admins = [], superAdmins = [] } = req.body;
      ...
      var newSuperAdmins = yield updateAdmins(
...
function _update() {
  _update = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      var { admins, superAdmins } = updatedCommunity;
...
function _updateAdmins() {
  _updateAdmins = (0, _asyncToGenerator2.default)(function*(admins, type, community) {
    ...
    var newAdminMembers = newAdmins.map(
      /*#__PURE__*/ (function() {
...
function _remove() {
  _remove = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      var { user } = req;
      var { id } = req.params; // check that user is an admin
