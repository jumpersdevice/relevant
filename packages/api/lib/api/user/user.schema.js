...
var remove = Object.keys(_user.default.schema.paths).filter(
  key => _user.default.schema.paths[key].options.select === false
);
var customizationOptions = {};
var TC = (0, _graphqlComposeMongoose.composeWithMongoose)(
  _user.default,
