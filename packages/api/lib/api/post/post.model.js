...
var { sendNotification } = require('../../notifications');
...
function _updateLatestComment() {
  _updateLatestComment = (0, _asyncToGenerator2.default)(function*(_ref) {
    var { post, communityId } = _ref;
    if (post.parentPost) return post;
    var latestComment = yield post
      .model('Post')
      .findOne(
        {
          parentPost: post._id,
...
PostSchema.methods.updateRank = /*#__PURE__*/ (function() {
  var _updateRank = (0, _asyncToGenerator2.default)(function*(_ref2) {
    var { communityId, updateTime } = _ref2;
    var post = this;
...
PostSchema.statics.newLinkPost = /*#__PURE__*/ (function() {
  var _newLinkPost = (0, _asyncToGenerator2.default)(function*(_ref3) {
    var { linkObject, postObject } = _ref3;
    var {
      tags,
      postDate,
      payoutTime,
    ...
    var post = yield this.model('Post')
      .findOne({
        url,
        type: 'link'
      })
...
PostSchema.methods.insertIntoFeed = /*#__PURE__*/ (function() {
  var _insertIntoFeed = (0, _asyncToGenerator2.default)(function*(
    communityId,
    community
  ) {
    try {
...
PostSchema.statics.sendOutMentions = /*#__PURE__*/ (function() {
  var _sendOutMentions = (0, _asyncToGenerator2.default)(function*(
    mentions,
    post,
    mUser,
    comment
      ...
      var promises = mentions.map(
        /*#__PURE__*/ (function() {
          var _ref6 = (0, _asyncToGenerator2.default)(function*(mention) {
            ...
            var users = yield _this
              .model('User')
              .find(query, 'deviceTokens email name notificationSettings');
            users.forEach(
              /*#__PURE__*/ (function() {
...
function _createMentionNotification() {
  _createMentionNotification = (0, _asyncToGenerator2.default)(function*(_ref8) {
    var { post, user, mUser, type, Notification, group, mention } = _ref8;
...
PostSchema.post(
  ...
  /*#__PURE__*/ (function() {
    var _postRemove = (0, _asyncToGenerator2.default)(function*(post, next) {
      ...
      var note = this.model('Notification')
        .deleteMany({
          post: post._id
        })
        .exec();
...
PostSchema.methods.incrementUnread = /*#__PURE__*/ (function() {
  var _incrementUnread = (0, _asyncToGenerator2.default)(function*(_ref10) {
    var { communityId, community } = _ref10;
