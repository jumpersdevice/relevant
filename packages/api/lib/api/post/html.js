...
exports.generatePreview = /*#__PURE__*/ (function() {
  var _ref2 = (0, _asyncToGenerator2.default)(function*(
    ...
    image =
      ...
      data.image; // why prioritise og tags? flipboard?
    ...
    var amp = $('[type="application/ld+json"]')
      .eq(0)
      .text();
    var ampKeywords;
    var ampAuthor;
        ...
        var by = article.byline
          ...
          .filter(
            a =>
              ...
              !a.match('http') // && !a.match(/2017|2016|2015|2018/)
          );
        author = by[0] ? [by[0]] : [];
      }
    }
