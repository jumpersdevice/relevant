...
exports.flagged = /*#__PURE__*/ (function() {
  var _ref = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      var { community, limit, skip } = req.query;
      var posts = yield _post.default
        .find({
          flagged: true
        })
        .populate([
  ...
  var _ref2 = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      posts = yield _postData.default
        ...
        .sort('-pagerank')
        .limit(20); // TODO do this on frontend?

      posts = posts.filter(d => d.post);
      posts = posts.map(d =>
        _objectSpread(
          _objectSpread({}, d.post.toObject()),
          {},
          {
            data: _objectSpread(
              _objectSpread({}, d.toObject()),
              {},
              {
...
exports.sendPostNotification = /*#__PURE__*/ (function() {
  var _ref3 = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    ...
    try {
      ...
      var alert = 'In case you missed this top-ranked post from @'
        .concat(post.user, ': ')
        .concat(post.title); // TODO - optimize this or put in queue so we don't create a bottle neck;

      var finished = users.map(
        /*#__PURE__*/ (function() {
  ...
  _sendFlagEmail = (0, _asyncToGenerator2.default)(function*() {
    ...
    var data = {
      ...
      html: 'Someone has flagged a post for inappropriate content\n      <br />\n      <br />\n      You can manage flagged content here:&nbsp;\n      <a href="'
        .concat(flaggedUrl, '" target="_blank">')
        .concat(flaggedUrl, '</a>\n      <br />\n      <br />')
    };
  ...
  var _ref8 = (0, _asyncToGenerator2.default)(function*(previewUrl, noReadability) {
    ...
    function _queryUrl() {
      _queryUrl = (0, _asyncToGenerator2.default)(function*(_url) {
        ...
        var processed = yield proxyHelpers.generatePreview(
          response.body,
          uri,
          _url,
          noReadability
...
function _processSubscriptions() {
  _processSubscriptions = (0, _asyncToGenerator2.default)(function*(
    newPost,
    communityId
  ) {
    try {
      var author = newPost.embeddedUser;
      var subscribers = yield _subscription.default
        .find({
        ...
        /*#__PURE__*/ (function() {
          var _ref15 = (0, _asyncToGenerator2.default)(function*(subscription) {
            ...
            try {
              ...
              yield feed.save();
              var now = new Date();
              var { follower } = subscription; // TODO put it on a queue, only certain hours of the day
              ...
              if (now - 12 * 60 * 60 * 1000 > new Date(follower.lastFeedNotification)) {
                ...
                var alert = 'There is a new post from '
                  .concat(author.name, ' in the ')
                  .concat(cObj.name, ' community');
                var payload = {
                  fromUser: author,
...
exports.create = /*#__PURE__*/ (function() {
  var _ref13 = (0, _asyncToGenerator2.default)(function*(req, res, next) {
    try {
      ...
      var { channel, body, postUrl: inputUrl } = req.body; // TODO rate limiting?
