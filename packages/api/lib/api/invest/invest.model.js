...
InvestSchema.methods.placeBet = /*#__PURE__*/ (function() {
  var _placeBet = (0, _asyncToGenerator2.default)(function*(_ref2) {
    var { post, communityId, stakedTokens, user } = _ref2;
    var vote = this;
    ...
    postData.expectedPayout = (0, _rewards.computePostPayout)(
      post.data,
      communityInstance
    );
    yield user.save();
...
InvestSchema.statics.createVote = /*#__PURE__*/ (function() {
  var _createVote = (0, _asyncToGenerator2.default)(function*(_ref3) {
    var { post, communityInstance, community, communityId, amount, user } = _ref3;
    var isManualBet =
      user.notificationSettings.bet.manual && communityInstance.betEnabled;
    if (!post.data)
      throw new Error(
    ...
    try {
      var stakedTokens =
        Math.abs(amount) *
        _globalConstants.VOTE_COST_RATIO *
...
function canBet(_ref5) {
  var { post, user, stakedTokens } = _ref5;
  var now = new Date();
