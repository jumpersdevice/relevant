...
var TreasuryTC = (0, _graphqlComposeMongoose.composeWithMongoose)(_treasury.default, customizationOptions); // STEP 3: Add needed CRUD User operations to the GraphQL Schema
  ...
  distributedTokens: {
    ...
    resolve: function () {
      var _resolve = (0, _asyncToGenerator2.default)(function* () {
        ...
        var curationRewards = balance - legacyTokens - airdropTokens - legacyAirdrop + cashedOut;
        var airdrop = legacyTokens + airdropTokens + legacyAirdrop;
        return _objectSpread(_objectSpread({}, ag[0]), {}, {
          curationRewards,
          airdrop,
          earned,
          rewardFund
