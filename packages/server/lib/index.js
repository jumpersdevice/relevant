...
process.env.WEB = 'true'; // This is needed in order to transpile react-native module (required by react-native-web-linear-gradient)
...
require("./server"); // prevents require images
