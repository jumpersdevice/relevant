...
const DAYS = HOURS * 24;
exports.DAYS = DAYS;
const PAYOUT_FREQUENCY = 1 * HOURS; // how often we compute payouts
...
const INTERVAL_INFLAITION = (1 + YEARLY_INFLATION) ** PAYOUT_FREQUENCY_FRACTION - 1;
exports.INTERVAL_INFLAITION = INTERVAL_INFLAITION;
const INIT_COIN = 1000000;
exports.INIT_COIN = INIT_COIN;
const SHARE_DECAY = 6 * DAYS; // time it takes to decay payout post shares

exports.SHARE_DECAY = SHARE_DECAY;
const TWITTER_DECAY = 12 * HOURS; // time it takes to decay payout post shares

exports.TWITTER_DECAY = TWITTER_DECAY;
const PAYOUT_TIME = 3 * DAYS; // time it takes for post to pay out

exports.PAYOUT_TIME = PAYOUT_TIME;
const VOTE_COST_RATIO = 0.1; // votes cost 10% of user balance
// export const NEW_USER_COINS = 20; // amount of coins new users get

exports.VOTE_COST_RATIO = VOTE_COST_RATIO;
const SLOPE = 1 / 1; // slope of bonding curve for posts

exports.SLOPE = SLOPE;
const EXPONENT = 1; // exponent for bonding curve price formula

exports.EXPONENT = EXPONENT;
const POWER_REGEN_INTERVAL = 24 * 60 * 60 * 1000; // 1 day to fully regenerate vote power

exports.POWER_REGEN_INTERVAL = POWER_REGEN_INTERVAL;
const RELEVANCE_DECAY = 90 * DAYS; // half life of relevance

exports.RELEVANCE_DECAY = RELEVANCE_DECAY;
const RELEVANCE_DECAY_POSTS = 90 * DAYS; // half life of relevance

exports.RELEVANCE_DECAY_POSTS = RELEVANCE_DECAY_POSTS;
const REP_CUTOFF = 2; // number of years before we ignore votes for users

exports.REP_CUTOFF = REP_CUTOFF;
const REP_CUTOFF_POSTS = 90 * DAYS; // time before we ignore votes for posts

exports.REP_CUTOFF_POSTS = REP_CUTOFF_POSTS;
const MINIMUM_RANK = 1; // minimum rank to be considered for rewards

exports.MINIMUM_RANK = MINIMUM_RANK;
const PUBLIC_LINK_REWARD = 5; // amount of tokens you get for public referral

exports.PUBLIC_LINK_REWARD = PUBLIC_LINK_REWARD;
const REFERRAL_REWARD = 20; // amount of tokens awarded both the referrer and referee

exports.REFERRAL_REWARD = REFERRAL_REWARD;
const TWITTER_REWARD = 20; // amount of tokens awarded for connecting twitter

exports.TWITTER_REWARD = TWITTER_REWARD;
const EMAIL_REWARD = 20; // amount of tokens awarded for connecting email
// TODO: Deprecate CASHOUT_LIMIT

exports.EMAIL_REWARD = EMAIL_REWARD;
const CASHOUT_LIMIT = 0; // amount of tokens one needs to earn to cash out

exports.CASHOUT_LIMIT = CASHOUT_LIMIT;
const CASHOUT_MAX = 1000;
exports.CASHOUT_MAX = CASHOUT_MAX;
const REDDIT_REWARD = 5;
exports.REDDIT_REWARD = REDDIT_REWARD;
const TOKEN_DECIMALS = 1e18;
exports.TOKEN_DECIMALS = TOKEN_DECIMALS;

const totalAllowedInvites = pagerank => {
...
const MAX_AIRDROP = 300;
exports.MAX_AIRDROP = MAX_AIRDROP;

const getRewardForType = type => {
  switch (type) {
    case 'reddit':
...
const BANNED_COMMUNITY_SLUGS = ['admin', 'user', 'channel', 'home', 'auth', 'profile', 'communities', 'subscriptions', 'graphql'];
exports.BANNED_COMMUNITY_SLUGS = BANNED_COMMUNITY_SLUGS;
const BANNED_USER_HANDLES = [...BANNED_COMMUNITY_SLUGS, 'everyone', 'group', 'all', 'invite'];
exports.BANNED_USER_HANDLES = BANNED_USER_HANDLES;

const userVotePower = pagerank => Math.round(Math.sqrt(1 + pagerank * 4));
