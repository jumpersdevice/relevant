...
function emailNotificationIsEnabled(_ref) {
  ...
  var isPersonal = noteType === 'reward' || noteType === 'reply' || noteType === 'mention';
...
function _getDefaultEmailHtml() {
  _getDefaultEmailHtml = (0, _asyncToGenerator2.default)(function* (_ref2) {
    ...
    var noteHtml = fromUser ? "<a href=\"".concat(userUrl, "\">").concat(fromUser.name, "</a> ").concat(action) : action;
    var subject = fromUser ? "".concat(fromUser.name, " ").concat(action) : action;
    var isReplyOrMention = noteType === 'reply' || noteType === 'mention';
    var html = "\n    <br/>\n    ".concat(toUser.name, ", ").concat(isReplyOrMention ? 'you have a new notification' : noteHtml, ":\n    <br />\n    <br />\n    <div class=\"post\" />\n      ").concat(isReplyOrMention ? '<div class="head">' + noteHtml + '</div>' : '', "\n      <a class=\"body\" href=\"").concat(postUrl, "\">\n        ").concat(post.body || post.title, "\n      </a>\n    </div>\n    <br />\n    <br />\n    <p class='footer'>You can adjust your email notification settings <a href=\"").concat(settingsUrl, "\">here</a></p>\n    ");
...
function _getNewPostHtml() {
  _getNewPostHtml = (0, _asyncToGenerator2.default)(function* (_ref3) {
    ...
    var noteHtml = "there is a new ".concat(postHtml, " from ").concat(fromHtml, " in the ").concat(community, " community");
    var subject = action;
    var html = "\n    <br/>\n    ".concat(toUser.name, ", ").concat(noteHtml, "\n    <br />\n    <br />\n    <p class='footer'>You can adjust your email notification settings <a href=\"").concat(settingsUrl, "\">here</a></p>\n    ");
    html = yield inlineCss(notificationStyle + html, {
      url: 'https://relevant.community'
    });
    return {
...
function _getRewardHtml() {
  _getRewardHtml = (0, _asyncToGenerator2.default)(function* (_ref4) {
    ...
    var subject = action;
    var html = "\n    <br/>\n    ".concat(toUser.name, ", ").concat(noteHtml, "\n    <br />\n    <br />\n    You can see all of your earnings in your <a href=\"").concat(walletUrl, "\">wallet</a>.\n    <br />\n    <br />\n    <p class='footer'>You can adjust your email notification settings <a href=\"").concat(settingsUrl, "\">here</a></p>\n    ");
    html = yield inlineCss(notificationStyle + html, {
      url: 'https://relevant.community'
    });
    return {
