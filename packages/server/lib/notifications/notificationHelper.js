...
module.exports.getUrls = ({
  ...
  const userUrl = fromUser ? `${process.env.API_SERVER}/user/profile/${fromUser.handle}` : null;
  const postUrl = `${process.env.API_SERVER}/${post.data ? post.data.community : post.community}/post/${postId}${replyIdSting}`;
