...
export const PUBLIC_LINK_REWARD = 0; // amount of tokens you get for public referral
export const REFERRAL_REWARD = 0; // amount of tokens awarded both the referrer and referee
