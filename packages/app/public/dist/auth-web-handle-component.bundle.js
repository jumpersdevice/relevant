  ...
  [28],
  {
                ...
                return (
                  ...
                  (e.handleChange = function(n) {
                    var t = e.props,
                      ...
                      d = t._reduxForm,
                      c = t.value,
                      l = x(n, { name: r, parse: i, normalize: u }),
                      f = !1;
                    if (s)
                      if (!j && Object(_.a)(n))
                        s(
              ...
              return (
                ...
                (o.render = function() {
                  ...
                  if ((r && (c.ref = this.ref), 'string' == typeof t)) {
                    var f = l.input;
                    l.meta;
                    return Object(d.createElement)(t, a()({}, f, {}, c));
                  }
                  return Object(d.createElement)(t, a()({}, l, {}, c));
                }),
                r
              );
            })(d.Component);
    ...
    './src/modules/auth/web/handle.component.js': function(e, n, t) {
      ...
      var r = t('../../node_modules/@babel/runtime/helpers/extends.js'),
        ...
        c = t.n(d),
        l = t('../../node_modules/@babel/runtime/helpers/inherits.js'),
        f = t.n(l),
      ...
      var R = (function(e) {
        ...
        function t(e) {
          ...
          return (
            i()(this, t),
            (r = n.call(this, e)),
            v()(c()(r), 'updateFormFields', function() {
              var e = r.props.user;
              r.FORM_FIELDS = [
                {
                  name: 'handle',
    ...
    './src/modules/styled/web.js': function(e, n, t) {
      ...
      var r = t('../../node_modules/react-router-dom/esm/react-router-dom.js'),
        ...
        b = Object(a.default)(c).withConfig({
