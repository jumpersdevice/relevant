  ...
  [38],
  {
    ...
    './src/modules/createPost/web/createPostModal.header.js': function(e, t, r) {
      ...
      var n = r('./node_modules/@babel/runtime/helpers/defineProperty.js'),
        ...
        l = r('../../node_modules/react-router/esm/react-router.js'),
        A = r('./src/modules/styled/uni.js'),
        f = r('./src/styles/index.js'),
        m = r('../../node_modules/@loadable/component/dist/loadable.esm.js'),
      ...
      function O(e) {
        ...
        if (!m)
          return (
            ...
            p.browserAlerts.alert('Please select a community first', 'error'),
            null
          );
        var g = { label: m.name, value: u },
          b = m.image ? { uri: m.image } : r('./public/img/default_community.png');
        return s.a.createElement(
          A.E,
          { style: { zIndex: 1 }, fdirection: 'row', align: 'baseline' },
          s.a.createElement(A.C, { mr: 1.5 }, 'Post to:'),
          s.a.createElement(A.s, {
            w: 2,
            h: 2,
            mr: 1,
            mt: 0.25,
      ...
      O.propTypes = { history: u.a.object };
      var w = {
        menu: function(e) {
          return b(b({}, e), {}, { borderRadius: 0, padding: 0, maxWidth: 300 });
        },
        container: function() {
          return { padding: '0px' };
        },
        option: function(e, t) {
          return b(
            b({ borderBottom: '1px solid '.concat(f.b.lightBorder) }, f.c.body),
            {},
            {
              color: t.isSelected ? f.b.blue : f.b.black,
              padding: Object(f.i)(2),
              cursor: 'pointer'
            }
          );
        },
        ...
        dropdownIndicator: function(e) {
          return b(b({}, e), {}, { padding: 0, cursor: 'pointer' });
        },
        ...
        singleValue: function(e, t) {
          ...
          return b(
            ...
            {
              cursor: 'pointer',
              fontSize: Object(f.i)(2.5),
              lineHeight: Object(f.i)(2.5),
              opacity: r,
