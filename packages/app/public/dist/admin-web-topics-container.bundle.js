(window.__LOADABLE_LOADED_CHUNKS__ = window.__LOADABLE_LOADED_CHUNKS__ || []).push([
  [20],
  {
    './src/modules/admin/web/topics.container.js': function(t, e, n) {
      'use strict';
      n.r(e);
      var r = {};
      n.r(r),
      ...
      var a = n('../../node_modules/@babel/runtime/helpers/toConsumableArray.js'),
        ...
        w = n('../../node_modules/@babel/runtime/regenerator/index.js'),
        x = n.n(w),
        k = n('../../node_modules/@babel/runtime/helpers/asyncToGenerator.js'),
        D = n.n(k),
        P = n('./src/core/actionTypes.js'),
        A = n('./src/utils/index.js');
      function S(t, e) {
        var n = Object.keys(t);
      ...
      function R(t) {
        return { type: P.Q, payload: t };
      }
      function B(t) {
        return { type: 'SELECT_TAG', payload: t };
      }
      function J(t) {
        return { type: 'DESELECT_TAG', payload: t };
      }
      function U(t) {
        return { type: P.Jb, payload: t };
      }
      function z(t) {
        return { type: P.bb, payload: t };
      }
      function H() {
        return function(t) {
          fetch('http://localhost:3000/api/tag?sort=count', {
            ...
            .catch(function(t) {
              return G('Error getting tags ' + t.message);
            });
        };
      }
      function K(t) {
        return function(e) {
          return t && '' !== t
            ? fetch('http://localhost:3000/api/tag/search/' + t, {
                credentials: 'include',
                method: 'GET',
                headers: {
                  Accept: 'application/json',
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.t0 = fetch),
                        (e.t1 = 'http://localhost:3000/api/tag'),
                        (e.t2 = L),
                        (e.t3 = L),
                        (e.t4 = {}),
                        (e.next = 7),
                    ...
                    case 7:
                      return (
                        ...
                        (e.t7 = {}),
                        (e.t8 = { method: 'POST', body: JSON.stringify(t) }),
                        ...
                        e.abrupt(
                          ...
                          (0, e.t0)(e.t1, e.t9)
                            ...
                            .catch(function(t) {
                              return (
                                G('error creating tag ' + t), { status: !1, data: t }
                              );
                            })
                        )
                      );
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.t0 = fetch),
                        (e.t1 = 'http://localhost:3000/api/tag/categories'),
                        (e.t2 = L),
                        (e.t3 = L),
                        (e.t4 = {}),
                        (e.next = 7),
                    ...
                    case 7:
                      return (
                        ...
                        (e.t6 = (0, e.t3)(e.t4, e.t5)),
                        (e.t7 = {}),
                        (e.t8 = { method: 'PUT', body: JSON.stringify(t) }),
                        (e.t9 = (0, e.t2)(e.t6, e.t7, e.t8)),
                        e.abrupt(
                          'return',
                          (0, e.t0)(e.t1, e.t9)
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.t0 = fetch),
                        (t.t1 = 'http://localhost:3000/api/tag/categories?active'),
                        (t.t2 = L),
                        (t.t3 = { method: 'GET' }),
                        (t.next = 6),
                        I()
      ...
      var V = (function(t) {
        ...
        function n(t) {
          ...
          return (
            c()(this, n),
            ((r = e.call(this, t)).state = { topic: '', emoji: '' }),
            (r.handleChange = r.handleChange.bind(p()(r))),
            (r.updateTag = r.updateTag.bind(p()(r))),
            r
          );
        }
        return (
          s()(n, [
            ...
            },
            {
              key: 'updateTag',
              value: function(t, e) {
                (e[t.target.name] = t.target.value),
                  this.props.actions.updateParentTag(e);
              }
            },
            {
              key: 'archiveTag',
              value: function(t) {
                (t.active = !t.active), this.props.actions.updateTag(t);
              }
            },
            {
              key: 'saveTag',
              value: function(t) {
                (t.main = t.main.split(', ').filter(function(t) {
                  return '' !== t;
                })),
                  (t.children = t.children.split(', ').filter(function(t) {
                    return '' !== t;
                  })),
                  this.props.actions.updateTag(t);
              }
            },
            {
              key: 'newTag',
              value: function() {
                ...
                this.props.actions.createTag(t);
              }
            },
            {
              key: 'render',
      ...
      v()(V, 'propTypes', { actions: C.a.object, tags: C.a.array }),
        (N = {
      ...
      e.default = Object(O.c)(
        function(t) {
          return { auth: t.auth, tags: t.tags };
        },
        function(t) {
          return { actions: Object(E.bindActionCreators)(r, t) };
        }
      )(V);
    }
  }
