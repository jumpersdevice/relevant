  ...
  [12],
  {
    './src/modules/admin/admin.actions.js': function(e, t, n) {
      ...
      var f = d.a.Alert(),
        ...
        b = new c.b.Entity('invites', {}, { idAttribute: '_id' }),
                  ...
                  for (;;)
                    switch ((r.prev = r.next)) {
                      ...
                      case 3:
                        return (
                          (s = r.sent),
                          (i = Object(c.a)({ invites: s }, { invites: [b] })),
                          o(y({ data: i, community: n, skip: e })),
                          r.abrupt('return', !0)
                        );
                      case 9:
                      ...
                      return (
                        ...
                        e.abrupt(
                          ...
                          (0, e.t0)(e.t1, e.t5)
                            ...
                            .then(function(e) {
                              var n = Object(c.a)({ wait: e }, { wait: [v] });
                              t(E(n));
                            })
                            .catch(function(e) {
    ...
    './src/modules/admin/web/downvotes.container.js': function(e, t, n) {
      'use strict';
      n.r(t);
      var r = n('./node_modules/@babel/runtime/helpers/classCallCheck.js'),
        ...
        j = n('./src/modules/listview/web/infScroll.component.js'),
        N = n('./src/utils/numbers.js');
      function R(e) {
        var t = (function() {
      ...
      var S = (function(e) {
        ...
        function n(e) {
          ...
          return (
            o()(this, n),
            ((r = t.call(this, e)).renderDownvote = r.renderDownvote.bind(u()(r))),
          ...
          a()(n, [
            {
              ...
              value: function(e) {
                return y.a.createElement(
                  'div',
                  { className: 'downvoteList', key: e._id },
                  y.a.createElement('div', { className: 'dUser' }, e.investor),
                  y.a.createElement('div', null, '- ', e.author),
                  y.a.createElement(
                    'div',
                    null,
                    Object(N.getDayMonthYearTimestamp)(e.createdAt)
                  ),
                  y.a.createElement(
                    'div',
                    null,
                    e.post
                      ? Object(N.getDayMonthYearTimestamp)(e.post.createdAt)
                      : '[deleted]'
                  )
                );
              }
            },
            {
              key: 'load',
              value: function(e) {
                var t = this.props.admin.downvotes.length;
                (this.hasMore = 40 * (e - 1) <= t),
                  this.hasMore && this.props.actions.getDownvotes(t, 40);
              }
            },
            {
              key: 'render',
              value: function() {
                var e = this,
                  t = this.props.admin.downvotes.map(function(t) {
                    return e.renderDownvote(t);
                  });
                return y.a.createElement(
                  'div',
                  null,
      ...
      b()(S, 'propTypes', { admin: w.a.object, actions: w.a.object }),
        (t.default = Object(O.c)(
          function(e) {
            return { auth: e.auth, admin: e.admin };
          },
          function(e) {
            return { actions: Object(_.bindActionCreators)(g, e) };
          }
        )(S));
    },
    './src/modules/listview/web/infScroll.component.js': function(e, t, n) {
      ...
      var r = n('./node_modules/@babel/runtime/helpers/objectWithoutProperties.js'),
        ...
        b = n.n(m),
        v = n('./node_modules/@babel/runtime/helpers/defineProperty.js'),
        y = n.n(v),
            ...
            },
            {
              ...
              value: function() {
                var e = this,
                  ...
                  r = t.element,
                  s = t.hasMore,
                  a = (t.initialLoad, t.isReverse, t.loader),
                  i =
                    (t.loadMore,
                    t.pageStart,
                    t.threshold,
                ...
                return (
                  ...
                  w.a.createElement(r, i, n, s && (a || this.defaultLoader))
                );
              }
            }
          ]),
