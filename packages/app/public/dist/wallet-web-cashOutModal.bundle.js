  ...
  [60, 4, 59],
  {
    ...
    '../../node_modules/@uniswap/sdk/dist/computation/trade.js': function(e, t, n) {
      ...
      t.getTradeDetails = function(e, t, n) {
        var r = i.normalizeBigNumberish(t),
          ...
          v = c.calculateDecimalRate(y, _),
          g = p(n.marketRate.rate, T.marketRate.rate),
          E = p(n.marketRate.rate, v.rate);
        return {
          marketDetailsPre: n,
          marketDetailsPost: T,
      ...
      t.getTokenReserves = function(e, t) {
        return (
          ...
          r(this, void 0, void 0, function() {
            var n, r, a, s, f, p, m, h, b, _, y, T, v, g, E, w, O, k;
            return o(this, function(o) {
              switch (o.label) {
                case 0:
                ...
                case 3:
                  return (
                    ...
                    (k = { token: v, amount: i.normalizeBigNumberish(w) }),
                    [2, { token: v, exchange: g, ethReserve: O, tokenReserve: k }]
                  );
              }
            });
          })
      ...
      function l(e, t) {
        ...
        switch (m) {
          ...
          case s.FIXED_UNDERFLOW_BEHAVIOR.ONE_DIGIT:
            var v = new o.default(_.toPrecision(1));
            return i(v, v.decimalPlaces(), void 0, b);
          default:
      ...
      !(function(o) {
        ...
        ((a = (function e(t) {
          var n,
            ...
            O,
            k,
            j = (H.prototype = { constructor: H, toString: null, valueOf: null }),
            A = new H(1),
            R = 20,
            x = 4,
            D = -7,
          ...
          function H(e, t) {
            var n,
              ...
              m,
              h = this;
            if (!(h instanceof H)) return new H(e, t);
            if (null == t) {
              ...
              if ((_(t, 2, B.length, 'Base'), 10 == t))
                return K((h = new H(e)), R + h.e + 1, x);
          ...
          function F(e, t, n, r) {
            ...
            if (((o = e.c[0]), (s = e.e), null == t))
              (i = h(e.c)),
                (i = 1 == r || (2 == r && (s <= D || s >= I)) ? T(i, s) : v(i, s, '0'));
            else if (
              ((a = (e = K(new H(e), t, n)).e),
              (u = (i = h(e.c)).length),
              1 == r || (2 == r && (t <= a || a <= D)))
          ...
          return (
              ...
              return function(t, r, o, a, s) {
                ...
                for (
                  b >= 0 &&
                    ...
                    (M = 0),
                    (t = t.replace('.', '')),
                    (f = (m = new H(r)).pow(t.length - b)),
                    (M = l),
                    (m.c = e(v(h(f.c), f.e, '0'), 10, o, '0123456789')),
                    (m.e = m.c.length)),
                    c = l = (p = e(
                      t,
                      r,
                      o,
                      s ? ((u = B), '0123456789') : ((u = '0123456789'), B)
                    )).length;
                  0 == p[--l];
                  p.pop()
                );
                ...
                if (
                  ...
                  t = d ? v(u.charAt(1), -_, u.charAt(0)) : u.charAt(0);
                else {
                  if (((p.length = i), d))
                  ...
                  for (
                    O = x.length,
                      ...
                      (h = i(u / (D[0] + 1))) > 1 &&
                        ...
                        (O = x.length)),
                      w = j,
                      g = (v = x.slice(0, j)).length;
                    g < j;
                    v[g++] = 0
                  );
                  (A = D.slice()), (A = [0].concat(A)), (k = D[0]), D[1] >= u / 2 && k++;
                  do {
                    if (((h = 0), (c = t(D, v, j, g)) < 0)) {
                      if (
                        ((E = v[0]),
                        j != g && (E = E * u + (v[1] || 0)),
                        (h = i(E / k)) > 1)
                      ...
                      if (
                        ...
                        for (; t(D, v, j, g) < 1; )
                          h++, n(v, j < g ? A : D, g, u), (g = v.length);
                    } else 0 === c && (h++, (v = [0]));
                    (T[f++] = h), v[0] ? (v[g++] = x[w] || 0) : ((v = [x[w]]), (g = 1));
                  } while ((w++ < O || null != v[0]) && R--);
                  (p = null != v[0]), T[0] || T.splice(0, 1);
                }
                if (u == d) {
                  for (f = 1, R = T[0]; R >= 10; R /= 10, f++);
                  K(y, a + (y.e = f + 14 * l - 1) + 1, s, p);
                } else (y.e = l), (y.r = +p);
                return y;
              };
            })()),
            ...
            (j.exponentiatedBy = j.pow = function(e, t) {
              ...
              if (
                ...
                return (
                  (f = new H(Math.pow(+Y(p), s ? 2 - y(e) : +Y(e)))), t ? f.mod(t) : f
                );
              if (((l = e.s < 0), t)) {
              ...
              return r
                ? f
                : (l && (f = A.div(f)), t ? f.mod(t) : a ? K(f, M, x, void 0) : f);
            }),
            (j.integerValue = function(e) {
              var t = new H(this);
              return null == e ? (e = x) : _(e, 0, 8), K(t, t.e + 1, e);
            }),
            (j.isEqualTo = j.eq = function(e, t) {
              return 0 === b(this, new H(e, t));
            }),
            (j.isFinite = function() {
              return !!this.c;
            }),
            (j.isGreaterThan = j.gt = function(e, t) {
              return b(this, new H(e, t)) > 0;
            }),
            (j.isGreaterThanOrEqualTo = j.gte = function(e, t) {
              return 1 === (t = b(this, new H(e, t))) || 0 === t;
            }),
            ...
            (j.minus = function(e, t) {
              var n,
                ...
                s = this,
                u = s.s;
              if (((t = (e = new H(e, t)).s), !u || !t)) return new H(NaN);
              ...
              var i = s.e / 14,
                ...
                f = e.c;
              if (!i || !c) {
                if (!l || !f) return l ? ((e.s = -t), e) : new H(f ? s : NaN);
                if (!l[0] || !f[0])
                  return f[0] ? ((e.s = -t), e) : new H(l[0] ? s : 3 == x ? -0 : 0);
              }
            ...
            (j.multipliedBy = j.times = function(e, t) {
              ...
              if (!(T && v && T[0] && v[0]))
                return (
                  !y.s || !e.s || (T && !T[0] && !v) || (v && !v[0] && !T)
                    ? (e.c = e.e = e.s = null)
                    : ((e.s *= y.s),
                      T && v ? ((e.c = [0]), (e.e = 0)) : (e.c = e.e = null)),
                  e
                );
              for (
                r = m(y.e / 14) + m(e.e / 14),
                  e.s *= y.s,
                  (i = T.length) < (f = v.length) &&
                    ((b = T), (T = v), (v = b), (o = i), (i = f), (f = o)),
                  o = i + f,
                  b = [];
                o--;
                b.push(0)
              ...
              for (_ = d, 1e7, o = f; --o >= 0; ) {
                for (
                  n = 0, p = v[o] % 1e7, h = (v[o] / 1e7) | 0, a = o + (s = i);
                  a > o;
              ...
              return n ? ++r : b.splice(0, 1), X(e, b, r);
            }),
            (j.negated = function() {
              var e = new H(this);
            ...
            (j.plus = function(e, t) {
              ...
              var a = r.e / 14,
                ...
                i = e.c;
              if (!a || !s) {
                if (!u || !i) return new H(o / 0);
                if (!u[0] || !i[0]) return i[0] ? e : new H(u[0] ? r : 0 * o);
              }
              ...
              for (
                ...
                (o = ((u[--t] = u[t] + i[t] + o) / d) | 0),
                  (u[t] = d === u[t] ? 0 : u[t] % d);
              return o && ((u = [o].concat(u)), ++s), X(e, u, s);
            }),
            (j.precision = j.sd = function(e, t) {
              var n,
                ...
                a = this;
              if (null != e && e !== !!e)
                return _(e, 1, p), null == t ? (t = x) : _(t, 0, 8), K(new H(a), e, t);
              if (!(n = a.c)) return null;
            ...
            (j.squareRoot = j.sqrt = function() {
              var e,
                ...
                d = new H('0.5');
              if (1 !== i || !u || !u[0])
                return new H(!i || (i < 0 && (!u || u[0])) ? NaN : u ? s : 1 / 0);
              if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      (+t && (+t.slice(1) || '5' != t.charAt(0))) ||
                        (K(r, r.e + R + 2, 1), (e = !r.times(r).eq(s)));
                      break;
                    }
                    if (!o && (K(a, a.e + R + 2, 0), a.times(a).eq(s))) {
                      r = a;
                      break;
                    }
                    (l += 4), (i += 4), (o = 1);
                  }
              return K(r, r.e + R + 1, x, e);
            }),
            ...
            (j.toFraction = function(e) {
              ...
              if (
                null != e &&
                ((!(i = new H(e)).isInteger() && (i.c || 1 !== i.s)) || i.lt(A))
              )
                throw Error(
                  c +
                    'Argument ' +
              ...
              return (
                null === a
                  ? o
                    ...
                    : (t = 'NaN')
                  : (null == e
                      ? (t = a <= D || a >= I ? T(h(n.c), a) : v(h(n.c), a, '0'))
                      : 10 === e
                      ? (t = v(h((n = K(new H(n), R + a + 1, x)).c), n.e, '0'))
                      : (_(e, 2, B.length, 'Base'),
                        (t = r(v(h(n.c), a, '0'), 10, e, o, !0))),
                    o < 0 && n.c[0] && (t = '-' + t)),
                t
              );
            }),
    ...
    '../../node_modules/lodash.clonedeepwith/index.js': function(e, t, n) {
      (function(e, n) {
        ...
        var k,
          ...
          K = C ? C.isBuffer : void 0,
          Y = w(Object.keys, Object),
          W = be(m, 'DataView'),
          z = be(m, 'Map'),
          G = be(m, 'Promise'),
          V = be(m, 'Set'),
                ...
                switch (t) {
                  ...
                  case s:
                    return (function(e, t, n) {
                      return v(t ? n(E(e), !0) : E(e), y, new e.constructor());
                    })(e, r, n);
                  case '[object Number]':
                  case '[object String]':
                    return new o(e);
                  ...
                  case u:
                    return (function(e, t, n) {
                      return v(t ? n(O(e), !0) : O(e), T, new e.constructor());
                    })(e, r, n);
                  case '[object Symbol]':
        ...
        function fe(e) {
          return (
            !(!Ae(e) || ((t = e), D && D in t)) && (je(e) || g(e) ? S : c).test(ge(e))
          );
          var t;
        }
        function pe(e) {
        ...
        ((W && '[object DataView]' != ye(new W(new ArrayBuffer(1)))) ||
          (z && ye(new z()) != s) ||
      ...
      var y = p.a.Alert(),
        ...
        O = function() {
          ...
          var e = Object(m.a)().getState,
            ...
            r = n.call,
            o = n.send;
          return g(), w(), { accounts: t.accounts, getState: e, call: r, send: o };
        },
        k = function(e) {
          var t = e.tx,
            n = e.method,
                      ...
                      t.el.current.measureInWindow(function(r, o, a, s) {
                        ...
                        r + o + a + s !== 0 &&
                          (o > b.a.get('window').height - 50 ||
                            (n(
                              Object(_.b)(
                                T(T({ name: t.name, parent: u }, v), {}, { data: t.data })
                              )
                            ),
                            n(Object(_.c)(e))));
                      }));
                      ...
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if ((s({ type: 'FETCH_PRICE_INIT' }), v && !g)) {
                                t.next = 3;
                                break;
                              }
    ...
    './src/modules/wallet/web/cashOutModal.js': function(e, t, n) {
      ...
      var r = n('../../node_modules/@babel/runtime/regenerator/index.js'),
        ...
        v = n('./src/utils/eth.js'),
        g = n('./src/modules/wallet/wallet.actions.js'),
      ...
      function I(e) {
        ...
        var h = (function(e, t) {
            var n = Object(y.a)().userNonce,
              r = n && 'SUCCESS' === n.phase && Object(v.e)(n.value),
