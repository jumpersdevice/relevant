(window.__LOADABLE_LOADED_CHUNKS__ = window.__LOADABLE_LOADED_CHUNKS__ || []).push([
  [21],
  {
                  ...
                  for (;;)
                    switch ((r.prev = r.next)) {
                      ...
                      case 3:
                        return (
                          (i = r.sent),
                          (s = Object(c.a)({ invites: i }, { invites: [b] })),
    ...
    './src/modules/admin/web/waitlist.component.js': function(t, e, n) {
        ...
        return (
          u()(n, [
            ...
            },
            {
              key: 'handleChange',
              value: function(t) {
                this.setState(b()({}, t.target.name, t.target.value));
              }
            },
            {
              key: 'renderWaitlist',
      ...
      b()(_, 'propTypes', { actions: j.a.object, admin: j.a.object }),
        (_.propTypes = { actions: j.a.object, admin: j.a.object }),
        (e.default = Object(g.c)(
          function(t) {
            return { auth: t.auth, admin: t.admin };
          },
          function(t) {
            return { actions: Object(O.bindActionCreators)(E, t) };
          }
        )(_));
    },
