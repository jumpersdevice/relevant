  ...
  [27],
  {
        ...
        y = function(e, n, t) {
          ...
          return {
            ...
            meta: o()({}, a(j), {
              ...
              submitting: !!C,
              submitFailed: !!E,
              touched: !(!j || !r(j, 'touched')),
              valid: !S,
              visited: !(!j || !r(j, 'visited'))
            }),
            custom: o()({}, T, {}, x)
          };
        },
                ...
                return (
                  ...
                  (e.handleChange = function(n) {
                    var t = e.props,
                      ...
                      d = t._reduxForm,
                      c = t.value,
                      l = j(n, { name: r, parse: i, normalize: s }),
                      f = !1;
                    if (u)
                      if (!x && Object(_.a)(n))
                        u(
                  ...
                  (e.handleBlur = function(n) {
                    var t = e.props,
                      ...
                      c = t._value,
                      l = t.value,
                      f = j(n, { name: r, parse: i, normalize: s });
                    f === c && void 0 !== c && (f = l);
                    var m = !1;
                    u &&
                      (x
    ...
    './src/modules/auth/web/forgot.component.js': function(e, n, t) {
      ...
      var r = t('../../node_modules/@babel/runtime/helpers/extends.js'),
        ...
        x = t.n(w),
        j = t('../../node_modules/react/index.js'),
        k = t.n(j),
    ...
    './src/modules/styled/web.js': function(e, n, t) {
      ...
      var r = t('../../node_modules/react-router-dom/esm/react-router-dom.js'),
        ...
        x = Object(o.default)(s.a).withConfig({
        ...
        j = Object(o.default)(i.a).withConfig({
