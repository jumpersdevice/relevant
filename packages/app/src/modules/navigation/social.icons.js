...
const TwitterIcon = require('public/img/twitter-black.png');
const EmailIcon = require('public/img/email.png');
const SlackIcon = require('public/img/slack.png');
const MediumIcon = require('public/img/medium.png');
const InstaIcon = require('public/img/instagram.png');
